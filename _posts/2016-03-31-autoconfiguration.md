...
[Skylark remote repositories](https://bazel.build/skylark/repository_rules.html) let you
create custom [external repositories](https://bazel.build/external.html) using
[Skylark](https://bazel.build/skylark/index.html). This not only enables creating rules for
...
of the `cc_autoconf` rule does the following step:
 ...
 - [Detect the `cpu_value`](https://github.com/bazelbuild/bazel/blob/9116b3e99af2fd31d92c9bb7c37905a1675456c1/tools/cpp/cc_configure.bzl#L85)
   using the [`repository_ctx.os.name`](https://bazel.build/skylark/lib/repository_os.html#name) attribute.
 ...
 - Detect the [C++ compiler path](https://github.com/bazelbuild/bazel/blob/9116b3e99af2fd31d92c9bb7c37905a1675456c1/tools/cpp/cc_configure.bzl#L235)
   using [`repository_ctx.which`](https://bazel.build/skylark/lib/repository_ctx.html#which) and the `CC` environment variable with
   [`repository_ctx.os.environ`](https://bazel.build/skylark/lib/repository_os.html#environ).
 - Detect some [more tool paths](https://github.com/bazelbuild/bazel/blob/9116b3e99af2fd31d92c9bb7c37905a1675456c1/tools/cpp/cc_configure.bzl#L53),
   still using [`repository_ctx.which`](https://bazel.build/skylark/lib/repository_ctx.html#which).
 - Generates the [various flag for the `CROSSTOOL` file](https://github.com/bazelbuild/bazel/blob/9116b3e99af2fd31d92c9bb7c37905a1675456c1/tools/cpp/cc_configure.bzl#L127),
   ...
   using [`repository_ctx.execute`](https://bazel.build/skylark/lib/repository_ctx.html#execute). We also
   ...
   with [`repository_ctx.execute`](https://bazel.build/skylark/lib/repository_ctx.html#execute).
 - With the gathered information, generate the C++ tools package: its [BUILD file](https://github.com/bazelbuild/bazel/blob/9116b3e99af2fd31d92c9bb7c37905a1675456c1/tools/cpp/cc_configure.bzl#L274),
   ...
   [`repository_ctx.template`](https://bazel.build/skylark/lib/repository_ctx.html#template).

So using the function provided by [`repository_ctx`](https://bazel.build/skylark/lib/repository_ctx.html), we can discover
...
When creating a Skylark remote repository, a few things should be taken in considerations:
 ...
 - Skylark remote repository can do a lot of non hermetic operation, it is recommended
   ...
   [`repository_ctx.download`](https://bazel.build/skylark/lib/repository_ctx.html#download) method.
