...
For instance, you could de-activate [Error Prone](https://errorprone.info)'s
[DepAnn](https://errorprone.info/bugpattern/DepAnn) checks by adding the
...
The complete documentation on rc file is [here](https://docs.bazel.build/versions/master/guide#bazelrc).
