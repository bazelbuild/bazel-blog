...
> Note: there is a known issue when using Bazel 0.28 with the IntelliJ plugin. Please see [the tracking issue](https://github.com/bazelbuild/bazel/issues/8571#issuecomment-510366705) for updates. A patch release containing the fix will be shipped shortly.
