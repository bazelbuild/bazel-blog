...
Thanks to our sponsors, Google, BuildBuddy, EngFlow, Trace Machina, AspectBuild, Gradle, Tweag, and VirtusLab, we invite you to join us for two days of insightful presentations, networking opportunities, and engaging discussions on all things Bazel. [Registration](https://events.linuxfoundation.org/bazelcon/) is now open.
